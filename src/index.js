const API_URL = 'https://tremendous-jelly-edam.glitch.me';
...
const createProductCart = ({id, photoUrl, name, price}) => {
    ...
    <article class="store__product product">
        <img src="${API_URL}${photoUrl}" alt="${name}" class="product__image" width="388px" height="261">
...
const submitOrder = async (e) => {
    ...
    try {
        ...
        console.error(`Ошибка оформления заказаЖ ${error}`);
    }
};
